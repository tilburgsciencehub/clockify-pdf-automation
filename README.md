...
### Prerequisites
In order to be able to run the script, you need to install the [pdfrw](https://pypi.org/project/pdfrw/) and [holidays](https://pypi.org/project/holidays/) libraries.
